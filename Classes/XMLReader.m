//
// XMLReader.m: http://troybrant.net/blog/2010/09/simple-xml-to-nsdictionary-converter/
//
#import "XMLReader.h"
#import "Constants.h"
...
- (BOOL)parse: (NSString *) apiUrl {
	...
	if (urlContents){
		...
		NSDictionary *xmlDictionary = [self dictionaryForXMLString:urlContents error:&parseError];
